...
def run_sort_type_str(value: ttypes.RunSortType) -> Optional[str]:
    ...
    if value == ttypes.RunSortType.NAME:
        return 'name'
    if value == ttypes.RunSortType.UNRESOLVED_REPORTS:
        return 'unresolved_reports'
    if value == ttypes.RunSortType.DATE:
        return 'date'
    if value == ttypes.RunSortType.DURATION:
        return 'duration'
    if value == ttypes.RunSortType.CC_VERSION:
