...
def upgrade():
    ...
    sa.Column('bug_hash', sa.String(), nullable=False),
    sa.Column('status', sa.Enum(u'unreviewed', u'confirmed', u'false_positive', u'intentional', name='review_status'), nullable=False),
    sa.Column('author', sa.String(), nullable=False),
    sa.Column('message', sa.Binary(), nullable=False),
    ...
    sa.Column('can_delete', sa.Boolean(), server_default=sa.text(u'true'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['content_hash'], [u'file_contents.content_hash'], name=op.f('fk_files_content_hash_file_contents'), ondelete=u'CASCADE', initially=u'DEFERRED', deferrable=True),
    ...
    sa.ForeignKeyConstraint(['run_id'], [u'runs.id'], name=op.f('fk_run_histories_run_id_runs'), ondelete=u'CASCADE', initially=u'DEFERRED', deferrable=True),
    ...
    sa.Column('detection_status', sa.Enum(u'new', u'unresolved', u'resolved', u'reopened', name='detection_status'), nullable=True),
    ...
    sa.ForeignKeyConstraint(['report_id'], [u'reports.id'], name=op.f('fk_bug_path_events_report_id_reports'), ondelete=u'CASCADE', initially=u'DEFERRED', deferrable=True),
    ...
    sa.ForeignKeyConstraint(['report_id'], [u'reports.id'], name=op.f('fk_bug_report_points_report_id_reports'), ondelete=u'CASCADE', initially=u'DEFERRED', deferrable=True),
