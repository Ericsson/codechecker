...
Build command which is used to build the project''')
        ...
        check_parser.add_argument('-u', '--suppress', type=str,
                                  ...
                                  help="Path to suppress file. \n"
                                       "Suppress file can be used to suppress"
                                       "analysis results during the"
                                       "analysis.\nIt is based on the bug "
                                       "identifier generated by the compiler "
                                       "which is experimental.\nDo not depend "
                                       "too much on this file because "
                                       "identifier or file format can be "
                                       "changed.\nFor other in source "
                                       "suppress features see the user guide.")
