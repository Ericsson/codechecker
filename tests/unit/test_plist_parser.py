...
class PlistParserTestCaseNose(unittest.TestCase):
    ...
    def test_clang40_plist(self):
        """
        Check plist generated by clang 4.0 checker name and bug hash
        should be in the plist file.
        """
        ...
        for bug in reports:
            ...
            if bug.checker_name == 'core.StackAddressEscape':
                self.__core_stack_addr_esc_event(bug.obsolate_main_section)
                self.assertEquals(
                    bug.hash_value, 'a6d3464f8aab9eb31a8ea7e167e84322')
            if bug.checker_name == 'deadcode.DeadStores':
                self.assertEquals(
                    bug.hash_value, '8714f42d8328bc78d5d7bff6ced918cc')
    ...
    def test_clang50_trunk_plist(self):
        """
        Check plist generated by clang 5.0 trunk checker name and bug hash
        should be in the plist file.
        """
