...
var BugList = {
  ...
  buildRow : function (data, id) {
    ...
    var file_col = document.createElement('td');
    var file_col_a = document.createElement('a');
    ...
    var severity_col = document.createElement('td');
    severity_col.setAttribute('class', 'severity');
    var severity_col_i = document.createElement('i');
    ...
    var checker_col = document.createElement('td');
    var checker_col_a = document.createElement('a');
    ...
    var review_col = document.createElement('td');
