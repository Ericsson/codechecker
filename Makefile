...
build_clang_scan_deps:
	$(MAKE) -C $(LLVM_PROJECT_DIR)/clang/tools/clang-scan-deps

package_clang_scan_deps: build_clang_scan_deps package_dir_structure
	cp -rp $(LLVM_PROJECT_DIR)/build/bin/clang-scan-deps $(CC_BUILD_BIN_DIR)
