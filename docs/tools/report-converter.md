...
[This project](https://gcc.gnu.org/wiki/StaticAnalyzer) introduces a static
analysis pass for GCC that can diagnose various kinds of problems in C/C++ code
at compile-time (e.g. double-free, use-after-free, etc).
